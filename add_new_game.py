...
parser.add_argument("--public-build", help="Link to the pages public builds")
parser.add_argument("--setting", help="The setting the game takes place in")
parser.add_argument("--developer", help="The dev")
...
parser.add_argument("--has-animation", help="Does the game have animations", action="store_true")
...
json_to_add = {"game": args.game, "public_build": args.public_build, "setting":args.setting, \
"developer": args.developer, "engine": args.engine, "visual_style":args.visual_style, "genre":args.genre, \
"animation":args.has_animation, "latest_version":args.latest_version, "download_link_windows": args.download_link_windows, \
"download_link_mac": args.download_link_mac, "download_link_linux": args.download_link_linux, \
"download_link_android":args.download_link_android}
